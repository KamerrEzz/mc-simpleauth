...
public class simpleauth
{
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "simpleauth" namespace
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "simpleauth" namespace
